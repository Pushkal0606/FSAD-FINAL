...
export const StudentAttendance = () => {
 ...
 switch (status) {
 case 'PRESENT':
 return 'bg-transparent border-[#a855f7] border';
 case 'ABSENT':
 return 'bg-transparent border-white border relative';
 case 'LATE':
 return 'bg-transparent border-white border relative';
 default:
 return 'bg-[#111] border border-[#333]';
 }
 };
 ...
 <h1 className="font-mono text-3xl font-bold text-white mb-6">Attendance</h1>
 ...
 <div
 key={day}
 className="aspect-square flex items-center justify-center font-mono text-xs text-gray-400 font-bold"
 >
 {day}
 </div>
 ))}
 ...
 {/* Summary */}
 <div className="bg-black rounded-sm border border-[#333] p-6">
 <div className="grid grid-cols-4 gap-4">
 <div className="text-center">
 <div className="font-mono text-xs text-gray-400 tracking-widest uppercase mb-1">
 Present
 </div>
 <div className="font-mono text-2xl font-bold text-[#a855f7]">{stats.present}</div>
 </div>
 <div className="text-center">
 <div className="font-mono text-xs text-gray-400 tracking-widest uppercase mb-1">
 Absent
 </div>
 <div className="font-mono text-2xl font-bold text-white">{stats.absent}</div>
 </div>
 <div className="text-center">
 <div className="font-mono text-xs text-gray-400 tracking-widest uppercase mb-1">
 Late
 </div>
 <div className="font-mono text-2xl font-bold text-white">{stats.late}</div>
 </div>
 <div className="text-center">
 <div className="font-mono text-xs text-gray-400 tracking-widest uppercase mb-1">
 Percentage
 </div>
 <div className="font-mono text-2xl font-bold text-[#a855f7]">{percentage}%</div>
 </div>
 </div>
 </div>
 </div>
