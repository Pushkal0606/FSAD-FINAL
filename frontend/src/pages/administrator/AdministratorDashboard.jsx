...
export const AdministratorDashboard = () => {
 ...
 <div>
 <h2 className="font-mono text-xl font-bold text-white mb-4">Department Overview</h2>
 <div className="space-y-3">
 {departments.map((dept) => (
 <div key={dept.name} className="bg-black rounded-sm border border-[#333] p-4">
 <div className="flex justify-between items-start mb-2">
 <h3 className="font-mono font-bold text-white">{dept.name}</h3>
 <span className="text-[#a855f7] font-mono text-sm">{dept.students} students</span>
 </div>
 <div className="w-full bg-[#111] border border-[#333] h-2">
 <div
