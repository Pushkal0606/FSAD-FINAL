...
export const Notices = () => {
 ...
 <h1 className="font-mono text-3xl font-bold text-white">Notices</h1>
 <button
 ...
 {notices.map((notice) => (
 <div key={notice.id} className="bg-black rounded-sm border border-[#333] p-4 hover:bg-[#111] transition-colors">
 <h3 className="font-mono font-bold text-white">{notice.title}</h3>
 ...
 <h2 className="font-mono font-bold text-white text-lg">Publish Notice</h2>
 <button onClick={() => setModalOpen(false)} className="text-gray-400 hover:text-[#a855f7] transition-colors">
 ✕
 </button>
 </div>
