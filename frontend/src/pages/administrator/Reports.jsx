...
export const Reports = () => {
 ...
 <h1 className="font-mono text-3xl font-bold text-white mb-6">Reports</h1>

 {/* Filters */}
 <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 bg-black rounded-sm border border-[#333] p-4">
 <div>
 ...
 className="w-full bg-black rounded-sm border border-white text-white font-mono text-sm px-4 py-2 hover:bg-[#a855f7] hover:text-black hover:border-[#a855f7] transition-all"
 >
 Generate
 </button>
 </div>
