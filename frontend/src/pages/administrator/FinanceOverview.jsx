...
export const FinanceOverview = () => {
 ...
 <h1 className="font-mono text-3xl font-bold text-white mb-6">Finance Overview</h1>

 {/* Stats */}
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
 {[
 { label: 'Paid', value: stats.paid, color: 'text-[#a855f7]' },
 { label: 'Unpaid', value: stats.unpaid, color: 'text-red-400' },
 { label: 'Partial', value: stats.partial, color: 'text-yellow-500' },
 ].map((stat) => (
 <div key={stat.label} className="bg-black rounded-sm border border-[#333] p-4 text-center">
