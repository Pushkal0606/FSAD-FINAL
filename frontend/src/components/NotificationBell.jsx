...
export const NotificationBell = () => {
 ...
 {isOpen && (
 <>
 <div className="absolute right-0 mt-2 w-80 bg-black rounded-sm border border-[#333] z-50">
 ...
 <div key={ann.id} className="border-b border-[#333] px-4 py-3 hover:bg-[#111] transition-colors">
 <p className="text-white text-sm font-mono font-bold line-clamp-1">{ann.title}</p>
 <p className="text-gray-400 text-xs font-mono mt-1">{ann.postedBy}</p>
 </div>
 ))
 )}
 </div>
 ...
 <button
 onClick={markAsRead}
 className="w-full text-[#a855f7] font-mono text-xs tracking-widest uppercase hover:text-white transition-colors"
 >
 Mark as Read
 </button>
 </div>
